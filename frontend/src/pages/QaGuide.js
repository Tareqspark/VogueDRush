...
const SUITE_LINKS = {
  ...
  'inv-ingredient-master': '/inventory/ingredients',
  'inv-recipe-bom':        '/inventory/recipes',
  'inv-stock-ledger':      '/inventory/ledger',
  'inv-physical-count':    '/inventory/physical-count',
  'inv-waste':             '/inventory/waste',
  'inv-expiry-batch':      '/inventory/waste',
  'inv-alerts-reorder':    '/inventory/alerts',
  // Module 2 – Purchase
  'po-lifecycle':          '/purchase/orders',
  'po-grn':                '/purchase/receiving',
  'po-3way-match':         '/purchase/matching',
  'po-returns':            '/purchase/returns',
  'po-invoice':            '/purchase/invoices',
  'po-landed-cost':        '/purchase/landed-cost',
  // Module 3 – Supplier
  'sup-master':            '/suppliers',
  'sup-ledger':            '/suppliers/ledger',
  'sup-payables-aging':    '/suppliers/payables',
  'sup-performance':       '/suppliers/performance',
  'sup-abc':               '/suppliers/segments',
  // Module 4 – CRM
  'crm-customer-master':   '/crm/customers',
  'crm-loyalty-account':   '/crm/loyalty',
  'crm-tier-engine':       '/crm/loyalty',
  'crm-coupon-engine':     '/crm/coupons',
  'crm-rfm':               '/crm/rfm',
  'crm-clv-cohort':        '/crm/clv',
  'crm-feedback':          '/crm/feedback',
  // Module 5 – Expense
  'exp-entry':             '/expenses',
  'exp-approval':          '/expenses/approval',
  'exp-recurring':         '/expenses/recurring',
  'exp-budget':            '/expenses/budget',
  // Module 6 – Accounting
  'acc-coa':               '/accounting/coa',
  'acc-journal':           '/accounting/journal',
  'acc-bank-recon':        '/accounting/bank-reconciliation',
  'acc-vat':               '/accounting/vat',
  'acc-pl-bs':             '/accounting/reports',
  'acc-period-close':      '/accounting/periods',
  // Module 7 – HR
  'hr-shifts':             '/hr/shifts',
  'hr-attendance':         '/hr/attendance',
  'hr-overtime':           '/hr/overtime',
  'hr-payroll-run':        '/hr/payroll',
  'hr-tips':               '/hr/tips',
  'hr-payroll-reports':    '/hr/payslips',
  // Module 8 – QR Ordering
  'qr-setup':              '/qr-ordering',
  'qr-menu-session':       '/qr-ordering/sessions',
  'qr-cart-payment':       '/qr-ordering/cart',
  'qr-tracking-feedback':  '/qr-ordering/status',
  // Module 9 – Fleet
  'fleet-rider':           '/fleet/riders',
  'fleet-zones':           '/fleet/zones',
  'fleet-assignment':      '/fleet/assignments',
  'fleet-tracking':        '/fleet/tracking',
  'fleet-commission':      '/fleet/commissions',
  // Module 10 – Advanced Reservations
  'res-floor-map':         '/advanced-reservations',
  'res-booking-engine':    '/advanced-reservations/book',
  'res-deposit':           '/advanced-reservations/deposits',
  'res-waitlist':          '/advanced-reservations/waitlist',
  'res-analytics':         '/advanced-reservations/analytics',
  // Module 11 – Branches
  'branch-setup':          '/branches/setup',
  'branch-isolation':      '/branches/access',
  'branch-transfer':       '/branches/transfers',
  'branch-central-dash':   '/branches/dashboard',
  // Module 12 – Business Intelligence
  'bi-peak-hour':          '/bi/peak-hours',
  'bi-menu-engineering':   '/bi/menu-engineering',
  'bi-cohort':             '/bi/cohorts',
  'bi-forecast':           '/bi/forecast',
  'bi-profitability':      '/bi/profitability',
  // Cross-module + non-feature
  'int-order-cogs':        '/orders',
  'int-purchase-pay':      '/purchase',
  'int-ops-payroll':       '/hr',
  'int-loyalty-flow':      '/crm',
  'perf-concurrency':      '/',
