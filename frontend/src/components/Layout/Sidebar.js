...
const NAV_SECTIONS = [
  {
    label: 'Operations',
    items: [
      { name: 'Dashboard',    href: '/',                  icon: HomeIcon,            roles: ['admin', 'manager', 'waiter', 'kitchen'] },
      { name: 'Orders',       href: '/orders',            icon: ShoppingCartIcon,    roles: ['admin', 'manager', 'waiter'] },
      { name: 'Kitchen',      href: '/kitchen',           icon: FireIcon,            roles: ['admin', 'manager', 'waiter', 'kitchen'] },
      { name: 'Reservations', href: '/reservations',      icon: CalendarDaysIcon,    roles: ['admin', 'manager', 'waiter'] },
      { name: 'Hold Orders',  href: '/hold-orders',       icon: PauseCircleIcon,     roles: ['admin', 'manager', 'waiter'] },
      { name: 'Cancelled',    href: '/cancelled-orders',  icon: XCircleIcon,         roles: ['admin', 'manager', 'waiter'] },
      { name: 'Delivery',     href: '/delivery',          icon: TruckIcon,           roles: ['admin', 'manager', 'waiter'] },
      { name: 'Tables',       href: '/tables',            icon: RectangleGroupIcon,  roles: ['admin', 'manager', 'waiter'] },
      { name: 'Collected',    href: '/collected-amount',  icon: BanknotesIcon,       roles: ['admin', 'manager'] },
    ],
  },
  {
    label: 'Management',
